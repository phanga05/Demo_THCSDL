...
('NCC0000010', N'Công ty J', N'Bà JM', '0123456780', '0123456780', 'j@company.com', N'Đường 10', 'PX002');
...
('KH00000010', N'Khách J', N'Bà J', 'j@khach.com', '0123456780', NULL, N'Đường 10', 'PX006');
...
('NV00000001', N'Nguyễn', 'A', '01-01-2000', '01-01-2020', '0123456789', 5000000, 1000000,N'123 Tôn Đực Thắng', 'PX001'),
...
('NV00000009', N'Nguyễn', 'I', '01-01-1988', '01-01-2017', '0123456781', 5700000, 1350000,N'15 Đỗ Quang', 'PX007'),
...
SELECT (NV.HO +' '+ NV.TEN) as [Họ và Tên],(NV.SoNhaTenDuong +','+ PX.TenPX +','+ QH.TenQuanHuyen +','+ TTP.TenTinhTP +','+ QG.TenQuocGia) as [Địa Chỉ],YEAR(NgayLamViec) AS NamBatDau
...
WHERE MaCongTy in ('NCC0000007','NCC0000006')
...
go
CREATE VIEW DiaChi AS
    SELECT PX.MaPX, PX.TenPX, QH.TenQuanHuyen, TTP.TenTinhTP, QG.TenQuocGia
    FROM PHUONGXA PX
...
SELECT 
    KH.TenCongTy,
    KH.TenGiaoDich,
    KH.SoNhaTenDuong + ', ' + AD.TenPX + ', ' + AD.TenQuanHuyen + ', ' + AD.TenTinhTP + ', ' + AD.TenQuocGia AS DiaChi,
    KH.DienThoai
FROM KHACHHANG KH
JOIN DiaChi AD ON KH.MaPXNo = AD.MaPX
...
SELECT 
    NCC.TenCongTy,
    NCC.TenGiaoDich,
    NCC.SoNhaTenDuong + ', ' + AD.TenPX + ', ' + AD.TenQuanHuyen + ', ' + AD.TenTinhTP + ', ' + AD.TenQuocGia AS DiaChi,
    NCC.DienThoai
FROM NHACUNGCAP NCC
JOIN DiaChi AD ON NCC.MaPXNo = AD.MaPX;
